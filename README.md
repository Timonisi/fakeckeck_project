# FakeCheck - Приложение для проверки фейковых аккаунтов ВКонтакте

Это мини-приложение ВКонтакте для анализа и выявления фейковых аккаунтов.  
Приложение использует [VK Bridge](https://github.com/VKCOM/vk-bridge), [VKUI](https://github.com/VKCOM/VKUI) и [VK Miniapps Router](https://github.com/VKCOM/vk-mini-apps-router) для создания современного интерфейса.  
В качестве сборщика проекта выступает [Vite](https://vite-docs-ru.vercel.app/guide/).

## 🔍 Возможности приложения

- **Анализ профилей ВКонтакте** - проверка подлинности аккаунтов
- **Детальная статистика** - анализ активности, даты регистрации, качества контента
- **Удобный интерфейс** - современный дизайн в стиле ВКонтакте
- **Быстрая проверка** - мгновенный анализ по ID или ссылке на профиль

## 🚀 Запуск мини приложения

Запустите ваше мини апп
